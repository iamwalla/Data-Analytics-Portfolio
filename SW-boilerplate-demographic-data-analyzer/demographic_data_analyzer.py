...
def calculate_demographic_data(print_data=True):
    ...
    tot = len(df)
    tot_bach = len(df[df["education"] == "Bachelors"])

    percentage_bachelors = round((tot_bach / tot) * 100, 1)
    ...
    higher_edu = df[df["education"].isin(["Bachelors", "Masters",
                                          "Doctorate"])]
    ...
    occupations=df[df['native-country']=='India']['occupation'].value_counts()
